...
<body>
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <span class="text">Submited Assingment </span>
    </div>
    ...
    <div class="student_list">
        <?php
            ...
            $qry3 = "SELECT * FROM `submit_assingment` WHERE `subject_id`='$subject_id'";
                    ...
                    <?php
                        while ($result3 = mysqli_fetch_assoc($data3)) 
                        {
                            echo "<tr>
                                    ...
                                    <td> ".$subject_name."</td>
                                    <td>".$sem."</td>
                                    <td><a href='display_submited_assingment.php?s_id=$result3[id]' class=containerx>Display</td>
                                 </tr>";
                        }
                        ?>
                </table>
