...
<body>
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <span class="text">Attach all Subject Book</span>
    </div>
    ...
    <?php
            ...
            $qry = "SELECT * FROM `book` WHERE `subjectname`='$subject_id'";
            ...
            <?php
                        while ($result = mysqli_fetch_assoc($data)) 
                        {
                            echo "<tr>
                                    ...
                                    <td><a href='delete_book.php?b_id=$result[id]'class=containerx>Delete</a></td>
                                    </tr>";
                        }
                        ?>
            </tabel>
