...
<body>
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <span class="text">Attach Subject Book</span>
    </div>
    ...
    <div class="add-student-form" style="text-align:center;">
        <form action="insert_book.php" method="post" enctype="multipart/form-data" >
            <table class="container">
              <tr>
                <td><label for="book">subject name</label></td>
                <td><input type="text" name="subeject_name" id="subject_name" value="<?php  echo $subject_name; ?>" readonly></td>
              </tr>
              <tr>
              ...
              <tr>
                <td><label for="bookfile">Book File</label></td>
