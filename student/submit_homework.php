...
<body>
  ...
  <section class="home-section">
    ...
    <div class="container">
        ...
        $sql3="SELECT * FROM `homework` WHERE `homework_id`='$id'";
        ...
        ?>
        <form action="insert_submited_homework.php" method="post" enctype="multipart/form-data" >
              <br>
              <label for="id">Homework Id</label>
