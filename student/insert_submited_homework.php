...
{
  $folder="../assets/documents/submited homework/".$file;
  echo $folder; 
...
if($file != "" && $sdate != "")
{
    $qry = "INSERT INTO `submit_homework` (`name`, `s_id`, `sdate`, `subject_id`, `sem`, `file`,`homework_id`) VALUE ('$name','$student_id','$sdate','$subject_id','$sem','$file','$id')";
