...
<?php
 $qry = "SELECT * FROM `homework` WHERE `sem`='$sem'";
...
else
{
    echo '<script>alert("no data found.")</script>';
                            ...
                            echo "<tr>
                                    ...
                                    <td>".$result['dos']."</td>
                                    <td><a href='display_homework.php?h_id=$result[homework_id]' class=containerx>Display</td>
                                    <td><a href='submit_homework.php?h_id=$result[homework_id]' class=containerx>Submit</td>
                                 </tr>";
                        }
                        ?>
    </table>
