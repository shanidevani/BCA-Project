...
<body>
  ...
  <section class="home-section">
    ...
    <div class="center">
        <div class="img1">
            <img src="../assets/img/dashmenu/student-64.png" alt="" srcset="">
        </div>
   ...
   $total2 = mysqli_num_rows($data2);
    ...
    <div class="center">
        <div class="img1">
            <img src="../assets/img/dashmenu/teacher-64.png" alt="" srcset="">
        </div>
        <div class="studenttext">
          <?php


   $qry1 = "SELECT * FROM `teacher` ";
   $data1 = mysqli_query($con, $qry1);

   $total1 = mysqli_num_rows($data1);
          ?>
            <b> ALL Teachers </b><br><br>
            <b><?php echo $total1;?></b>
        </div>
    </div>
    <div class="center">
        <div class="img1">
            <img src="../assets/img/dashmenu/request-64.png" alt="" srcset="">
        </div>
        <div class="studenttext">
        <?php
  

   $qry3 = "SELECT * FROM `contact` ";
   $data3 = mysqli_query($con, $qry3);

   $total3 = mysqli_num_rows($data3);
          ?>
            <b> ALL Request </b><br><br>
            <b><?php  echo $total3; ?></b>
        </div>
    </div><br><br>
