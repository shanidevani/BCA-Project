...
<body>
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <span class="text">UPDATE SUBJECTS</span>
    </div>
      ...
      ?>
        <table class="container">
            <tr>
                ...
                <td><input type="text" name="subject_id" id="subject_id" value="<?php echo $result['subject_id']; ?>" readonly></td>
    </tr>
            
<tr>
<td><label>subject name</label></td>
    <td><input type="text" name="subject-name" id="subject-name" value="<?php echo $result['subject_name']; ?>" placeholder="SUBJECT NAME"></td>
</tr>
<tr>
    <td><label>subject code</label></td>
    <td><input type="text" name="subject-code" id="subject-code" value="<?php echo $result['subject_code']; ?>" placeholder="SUBJECT CODE"></td>
</tr>
<tr>
    <td><lable>subject type</lable></td>
    <td><select name="subject_type">
        <option value="select"
        <?php
            if($result['subject_type'] == "select")
            {
              echo "selected";
            }
          ?>
        ...
        <?php
            if($result['subject_type'] == "Practical")
            {
              echo "selected";
            }
          ?>
        ...
        <?php
            if($result['subject_type'] == "Mandatory")
            {
              echo "selected";
            }
          ?>
