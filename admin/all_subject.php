...
<body>
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <span class="text">ALL SUBJECTS</span>
    </div>
                    ...
                    <?php
                        while ($result = mysqli_fetch_assoc($data)) 
                        {
                            echo "<tr>
                                    ...
                                    <td> ".$result['sem']."</td>
                                    <td> <a href='edit_subject.php?s_id=$result[subject_id]'class=container>Edit</a></td>
                                    <td><a href='delete_subject.php?s_id=$result[subject_id]'class=container>Delete</a></td>
                                 </tr>";
                        }
                        ?>
                </table>
