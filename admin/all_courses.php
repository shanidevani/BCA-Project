...
<body>
  ...
  <section class="home-section">
    ...
    <form action="insert_class.php" method="post">
        <input type="submit" name="add_class" id="add_class" value="INSERT CLASS">
      </form>
        <?php
            include '../application/config/config.php';
                    ...
                    <?php
                        while ($result = mysqli_fetch_assoc($data)) 
                        {
                            echo "<tr>
                                    ...
                                    <td> ".$result['name']."</td>
                                    <td> <a href='edit_courses.php?c_id=$result[courses_id]'class=container>Edit</a></td>
                                    <td><a href='delete_courses.php?c_id=$result[courses_id]'class=container>delete</a></td>
                                 </tr>";
                        }
                        ?>
                </table>
