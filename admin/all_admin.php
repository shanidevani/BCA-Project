...
<body>
  ...
  <section class="home-section">
    ...
    <form action="add_admin.php" method="post">
        <input type="submit" name="add_admin" id="add_admin" value="INSERT ADMIN">
      </form>
        <?php
            include '../application/config/config.php';
            ...
            if($total)
            {
                ...
                <table style="border: 2px solid #000;" class="container">
                    ...
                    <?php
                        while ($result = mysqli_fetch_assoc($data)) 
                        {
                            $folder = "../assets/img/profile/admin/".$result['profile'];
                            echo "<tr>
                                    <td> ".$result['id']."</td>
                                    <td> ".$result['username']."</td>
                                    <td><img src=".$folder." width='100px' height='100px'></td>
                                    <td> <a href='edit_admin.php?a_id=$result[id]'class=container>Edit Password</a></td>
                                    <td><a href='delete_admin.php?a_id=$result[id]'class=container>delete</a></td>
                                 </tr>";
                        }
                        ?>
                </table>
