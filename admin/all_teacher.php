  ...
  <section class="home-section">
    ...
    <div class="student_list">
      <form action="add_teacher.php" method="post">
        <input type="submit" name="add_teacher" id="add__teacher" value="INSERT TEACHER">
      </form>
        <?php
            include '../application/config/config.php';
            ...
            {
                ?>
                <table style="border: 1px solid #000;" class="container">
                    <tr>
                    ...
                    <?php
                        while ($result = mysqli_fetch_assoc($data)) 
                        {
                          $folder = "../assets/img/profile/teacher/".$result['profile_picture'];
                            echo "<tr>
                            <td><a href='edit_teach.php?s_id=$result[teacher_id]' class= containerx>Edit</a></td>
                            <td><a href='del_teacher.php?s_id=$result[teacher_id]' class= containerx>Delete</a></td>
