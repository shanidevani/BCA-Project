...
<body>
  ...
  <section class="home-section">
    ...
    <?php
      include '../application/config/config.php';
        $query2 = "SELECT * FROM  `teacher` ORDER BY `teacher_id` DESC LIMIT 1";
        ...
        else
        {
            ...
            $customer_ID = "RSNOFT" . ($customer_ID + 1);
        }
    ...
    ?>
      ...
      <table class="container">
        <tr>
          ...
          <td><input type="text" name="r_no" id="r_no" value="<?php echo $customer_ID; ?>" readonly ></td>
