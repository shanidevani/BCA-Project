  ...
  <section class="home-section">
    ...
    <form action="insert_subject.php" method="post">
        <table class="container">
            ...
            {
                ?>
  <td colspan=""><label>courses</label></td>
  <td colspan="2"><select name="courses">
...
<td><label>subject name</label></td>
    <td><input type="text" name="subject-name" id="subject-name" placeholder="SUBJECT NAME"></td>
</tr>
<tr>
    <td><label>subject code</label></td>
    <td><input type="text" name="subject-code" id="subject-code" placeholder="SUBJECT CODE"></td>
</tr>
