  ...
  <section class="home-section">
    ...
    <div class="add-student-form" style="text-align:center;">
      ...
      <table class="container">
          <tr>
              <td><label>Photos - 1</label></td>
              <td><input type="file" name="file1" id="file1" ></td>
</tr>
<tr>
              <td><label>Photos - 2</label></td>
              <td><input type="file" name="file2" id="file2" ></td>
</tr>
<tr>
              <td><label>Photos - 3</label></td>
              <td><input type="file" name="file3" id="file3" ></td>
</tr>
<tr>
              <td><label>Photos - 4</label></td>
              <td><input type="file" name="file4" id="file4" ></td>
</tr>
<tr>
              <td><label>Photos - 5</label></td>
              <td><input type="file" name="file5" id="file5" ></td>
</tr>
<tr>
              <td><label>Photos - 6</label></td>
              <td><input type="file" name="file6" id="file6" ></td>
</tr>
<tr>
              <td><label>Photos - 7</label></td>
              <td><input type="file" name="file7" id="file7" ></td>
</tr>
<tr>
              <td><label>Photos - 8</label></td>
              <td><input type="file" name="file8" id="file8" ></td>
</tr>
<tr>
              <td><label>Photos - 9</label></td>
              <td><input type="file" name="file9" id="file9" ></td>
</tr>
<tr>
